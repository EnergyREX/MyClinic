...
const Register = () => {
  ...
  return (
    <>
      ...
      <AuthLayout>
        <div className="bg-neutral-300 p-5 rounded-lg dark:bg-neutral-700 dark:text-white max-w-md w-full shadow-lg shadow-neutral-700 dark:shadow-neutral-200/20 my-5">
          ...
          <div>
            <form className="flex flex-col gap-4" onSubmit={onSubmit}>
              ...
              <InputField
                ...
                type="text"
                placeholder={t("placeholders.phoneNum")}
          ...
          <Link
            className="font-light pt-2 dark:text-white flex gap-2 hover:text-sky-500 duration-100 py-2"
            to={"/login"}
          >
