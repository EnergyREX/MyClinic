      ...
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          ...
          <Route
            path="/jwt-tokens"
            element={
              <ProtectedRoute permission="view_jwttokens">
                <JWTTokens />
              </ProtectedRoute>
            }
          />
          <Route
            path="/appointments"
            element={
              <ProtectedRoute permission="view_appointments">
                <Appointments />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute permission="view_medical_records">
                <MedicalRecords />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            path="/treatments"
            element={
              <ProtectedRoute permission="view_treatments">
                <Treatments />
              </ProtectedRoute>
            }
          />
